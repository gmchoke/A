...
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/gmchoke/new1/master/iptables"
...
mv vnstat_php_frontend-1.5.1.tar.gz /var/www/html/vnstat
