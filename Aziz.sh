...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/gmchoke/GMCHOKE1/master/sources.list.debian"
wget "https://raw.githubusercontent.com/gmchoke/GMCHOKE1/master/dotdeb.gpg"
